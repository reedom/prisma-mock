...
const createPrismaMock = (originalData = {}, datamodel = client_1.Prisma.dmmf.datamodel, client = (0, jest_mock_extended_1.mockDeep)(), options = {
    caseInsensitive: false,
}) => {
    let data = (0, deepCopy_1.deepCopy)(originalData);
